...
<div class="app-layout">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <?php if($_SESSION['role'] == 'admin') { ?>
                ...
                <a href="../admin/add_room.php" class="active"><span class="nav-icon">🏠</span> Add Room</a>
    ...
    <main class="main-content">
        <h2 class="fade-in">Create New Room</h2>
        <p class="page-subtitle fade-in fade-in-delay-1">Register new accommodation units in the system.</p>
        ...
        <div class="glass-card fade-in fade-in-delay-2" style="max-width: 500px;">
            <form method="post" action="">
                ...
                <div class="form-group">
                    <label>Room Assignment Type</label>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="capacity" min="1" placeholder="Number of available beds" required>
                </div>
                
                <div class="mt-4">
                    <input type="submit" name="add" value="Create Room" class="btn btn-primary" style="width: 100%;">
                </div>
            </form>
        </div>
        
        <div class="glass-card fade-in fade-in-delay-3 mt-4" style="max-width: 500px; font-size: 13px; color: var(--text-secondary);">
            <p><strong>💡 Quick Tip:</strong> Room capacity defines how many students can be allocated. The system automatically tracks availability based on this number.</p>
        </div>
    </main>
</div>
